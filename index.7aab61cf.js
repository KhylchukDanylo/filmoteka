 ...
 * limitations under the License.
 */
class Hu{operationForChild(e){return Uc(this.path)?new Hu(this.source,Oc(),this.snap.getImmediateChild(e)):new Hu(this.source,Dc(this.path),this.snap)}constructor(e,t,n){this.source=e,this.path=t,this.snap=n,this.type=Wu.OVERWRITE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vu{operationForChild(e){if(Uc(this.path)){const t=this.children.subtree(new Ac(e));return t.isEmpty()?null:t.value?new Hu(this.source,Oc(),t.value):new Vu(this.source,Oc(),t)}return Li(Lc(this.path)===e,"Can't get a merge for a child not on the path of the operation"),new Vu(this.source,Dc(this.path),this.children)}toString(){return"Operation("+this.path+": "+this.source.toString()+" merge: "+this.children.toString()+")"}constructor(e,t,n){this.source=e,this.path=t,this.children=n,this.type=Wu.MERGE}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
